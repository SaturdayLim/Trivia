...
| 33 | Repo visibility + GitHub Pages | LOCKED (user) | User removed `questions/archive-nsfw.md` and `questions/archive-nat.md` (Nat's birthday-personalized category) 2026-07-04, clearing the world-readable-content blocker. Repo made public and GitHub Pages enabled at https://saturdaylim.github.io/Trivia/ |
