...
| 6 | Open-answer per-round flag; all correct teams score full; earliest lock per team | LOCKED | maps to v6 Comm phase |
...
| 10 | Challenge: symmetric ± full multiplied value | LOCKED | solo-mode questions; contrasting pick enforced; per-team earliest lock |
...
| 22 | Phases Comm/Solo/Crown/Target exist; H1 phase value | MINED | Phases.bas; Crown/Target semantics pending RULES-v6.md |
...
| 27 | Crown/Target mechanics, v6 challenge stakes | OPEN (mining) | Task 1 |
